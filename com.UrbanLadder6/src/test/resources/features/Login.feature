...
Feature: User Registration,Account Settings and Login
  ...
  Scenario: Edit Account Settings - Change Password
    ...
    Examples:
      ...
      |  sample478@demo.com  | Hello@478     | Alan N     | 7947526486  | Lock@478          | Lock@478          |      
  ...
  Scenario Outline: Login with different credentials
    ...
    Examples:
      ...
      | sample478@demo.com   | Hello@022     |
      | test86@test.com      | Lock@478      |
      | sample478@demo.com   | Lock@478      |
